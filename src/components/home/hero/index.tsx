...
function Hero() {
    return (
        <section className='relative w-full min-h-[700px] lg:h-[700px] '>
            <div>
                <Image src='/hero.jpg' fill sizes='100vw' alt='hero' className='object-cover aspect-auto' />
            </div>
            <div className='absolute bg-black/20 z-10 inset-0 flex flex-col justify-center section'>
                <div className="container section">
                    ...
                    <motion.h1 initial={{ opacity: 0, y: 50 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.3 }} className='max-w-xl text-white text-3xl lg:text-5xl font-bold mb-4'>
                        Se concentrer essentiellement sur l’accompagnement
                        de la jeunesse.
                    </motion.h1>

                    <motion.p initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.5 }} className="max-w-xl text-xs lg:text-sm before:content-[''] ml-3 before:left-[-15px] font-light text-white before:h-full  before:w-[2px]  before:absolute before:top-0 before: before:bg-orange relative mb-8">
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.7 }} className=''>
                        <Link href='/a-propos'>
